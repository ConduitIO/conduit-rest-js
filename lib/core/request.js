...
const sendRequest = async (config, options, url, formData, body, headers, onCancel) => {
    ...
    return new CancelablePromise_1.CancelablePromise(async (resolve, reject, onCancel) => {
        try {
            ...
            if (!onCancel.isCancelled) {
                const response = await (0, exports.sendRequest)(config, options, url, formData, body, headers, onCancel);
